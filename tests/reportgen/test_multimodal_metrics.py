...
from inference_perf.apis import InferenceInfo, StreamedInferenceResponseInfo
...
def test_summarize_requests_multimodal_metrics() -> None:
    ...
    metric1.info.response_info = StreamedInferenceResponseInfo(
        response_chunks=[],
        chunk_times=[0.5, 1.5],
        output_tokens=20,
    ...
    metric2.info.payload = Payload(
        text=Text(input_tokens=15, output_tokens=25),
        video=Videos(
            count=1,
    ...
    metric2.info.input_tokens = 15
    metric2.info.response_info = StreamedInferenceResponseInfo(
        response_chunks=[],
        chunk_times=[1.5, 2.5],
        output_tokens=25,
